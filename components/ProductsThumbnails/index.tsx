...
import { GetProductsThumbnailsQueryVariables } from '@/graphql/generated/graphql';
import { useEffect } from 'react';

export const ProductsThumbnails = ({ productsThumbnails }: GetProductsThumbnailsQueryVariables) => {
  useEffect(() => {
    console.log(productsThumbnails);
  }, [productsThumbnails]);
