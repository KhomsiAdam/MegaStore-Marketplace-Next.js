...
const Home: NextPage = () => {
  ...
  return (
    <div className='h-full xl:h-[520px] overflow-hidden rounded-lg shadow-bm relative flex justify-between'>
      <CategoriesList />
      <div className='w-full xl:w-[75%] flex flex-col justify-between lg:ml-3'>
        <div className='w-full h-[calc(90%-0.75rem)] rounded-lg hidden xl:grid xl:gap-3 xl:grid-cols-[3fr_7fr]'>
          <div className='flex w-full h-full bg-white rounded-lg'></div>
